...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Domain.parent'
        db.add_column('domains_domain', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['domains.Domain'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Domain.parent'
        db.delete_column('domains_domain', 'parent_id')
    ...
    models = {
        ...
        'domains.domain': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['domains.Domain']", 'null': 'True', 'blank': 'True'}),
