...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Domain.enable'
        db.add_column('domains_domain', 'enable', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Domain.enable'
        db.delete_column('domains_domain', 'enable')
