...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Credit.bonus'
        db.add_column('stats_credit', 'bonus', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Credit.bonus'
        db.delete_column('stats_credit', 'bonus')
