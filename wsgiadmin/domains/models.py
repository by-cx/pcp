...
class registration_request(models.Model):
	name		= models.CharField(_(u"Název domény"),max_length=100,unique=True)
	pub_date	= models.DateField(auto_now=True)
	kind		= models.CharField(_(u"Registrace/transfer"),max_length=20,choices=(("registration",_(u"Registrace nové domény")),("transfer",_(u"Přesunutí existující domény"))))
...
#class form_registration_request(ModelForm):
#	class Meta:
#		model = registration_request
#		exclude = ["pub_date","owner"]

CHOICES=[(".cz",".cz"), (".eu",".eu"), (".cz.cc",".cz.cc"), (".co.cz",".co.cz"), (".com",".com"), (".org",".org"), (".net",".net"), (".biz",".biz"), (".info",".info"), (".name",".name")]
...
class form_registration_request_years(forms.Form):
	...
	passwd		= forms.CharField(label=_(u"Heslo pro transfer"),required=False,help_text=_(u"Nepovinné. Bude dočasně uloženo v databázi v textové podobě."))
