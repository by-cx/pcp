...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('dns_domain', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Domain', fields ['name']
        db.delete_unique('dns_domain', ['name'])
    ...
    models = {
        ...
        'dns.domain': {
            ...
            'nss': ('django.db.models.fields.CharField', [], {'default': "'ns1.rosti.cz ns2.rosti.cz'", 'max_length': '512'}),
