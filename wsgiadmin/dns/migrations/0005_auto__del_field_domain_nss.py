...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Domain.nss'
        db.delete_column('dns_domain', 'nss')


    def backwards(self, orm):
        # Adding field 'Domain.nss'
        db.add_column('dns_domain', 'nss',
                      self.gf('django.db.models.fields.CharField')(default='ns1.rosti.cz ns2.rosti.cz', max_length=512),
                      keep_default=False)
