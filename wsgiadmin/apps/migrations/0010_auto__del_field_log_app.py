...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Log.app'
        db.delete_column('apps_log', 'app_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Log.app'
        raise RuntimeError("Cannot reverse this migration. 'Log.app' and its values cannot be restored.")
