...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('clients_address', 'zip', self.gf('django.db.models.fields.CharField')(max_length=12))

    def backwards(self, orm):

        # Changing field 'Address.zip'
        db.alter_column('clients_address', 'zip', self.gf('django.db.models.fields.CharField')(max_length=6))
