...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Record.ttl'
        db.alter_column('dns_record', 'ttl', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Record.ttl'
        db.alter_column('dns_record', 'ttl', self.gf('django.db.models.fields.IntegerField')())
