...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'App.domains'
        db.alter_column(u'apps_app', 'domains', self.gf('django.db.models.fields.CharField')(default='_', max_length=512))

    def backwards(self, orm):

        # Changing field 'App.domains'
        db.alter_column(u'apps_app', 'domains', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
