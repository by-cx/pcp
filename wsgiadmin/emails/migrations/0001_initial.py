...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('emails_email', (
            ...
            ('uid', self.gf('django.db.models.fields.IntegerField')(default='117')),
            ('gid', self.gf('django.db.models.fields.IntegerField')(default='118')),
            ('homedir', self.gf('django.db.models.fields.CharField')(default='/var/mail', max_length=100)),
        ...
        db.send_create_signal('emails', ['EmailRedirect'])
    ...
    models = {
        ...
        'emails.emailredirect': {
            'Meta': {'object_name': 'EmailRedirect', 'db_table': "'emails_redirect'"},
