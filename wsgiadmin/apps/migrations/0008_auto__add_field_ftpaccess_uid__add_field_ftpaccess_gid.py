...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FtpAccess.uid'
        db.add_column(u'apps_ftpaccess', 'uid',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'FtpAccess.gid'
        db.add_column(u'apps_ftpaccess', 'gid',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FtpAccess.uid'
        db.delete_column(u'apps_ftpaccess', 'uid')

        # Deleting field 'FtpAccess.gid'
        db.delete_column(u'apps_ftpaccess', 'gid')
