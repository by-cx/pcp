...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'emails_message', (
            ...
            ('lang', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True)),
        ...
        db.create_table(u'emails_email', (
            ...
            ('domain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emails.Domain'], null=True)),
            ('password', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'emails', ['Email'])

        # Adding model 'EmailRedirect'
        db.create_table('emails_redirect', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ...
        db.send_create_signal(u'emails', ['EmailRedirect'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('emails_redirect')
    ...
    models = {
        ...
        u'emails.domain': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'email_domain_set'", 'to': u"orm['auth.User']"})
        },
        u'emails.email': {
            'Meta': {'object_name': 'Email'},
            'domain': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['emails.Domain']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'login': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'emails.emailredirect': {
