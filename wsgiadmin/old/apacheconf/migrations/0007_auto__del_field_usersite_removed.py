...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserSite.removed'
        db.delete_column('apacheconf_site', 'removed')


    def backwards(self, orm):
        # Adding field 'UserSite.removed'
        db.add_column('apacheconf_site', 'removed',
    ...
    models = {
        ...
        'apacheconf.usersite': {
            ...
            'misc_domains': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'misc_domains'", 'to': "orm['domains.Domain']", 'through': "orm['apacheconf.SiteDomain']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
