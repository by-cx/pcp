...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TransId.trans_id'
        db.alter_column(u'stats_transid', 'trans_id', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'TransId.trans_id'
        db.alter_column(u'stats_transid', 'trans_id', self.gf('django.db.models.fields.IntegerField')())
