...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FtpAccess'
        db.create_table(u'apps_ftpaccess', (
            ...
            ('directory', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apps.App'])),
        ))
        db.send_create_signal(u'apps', ['FtpAccess'])


    def backwards(self, orm):
        # Deleting model 'FtpAccess'
        db.delete_table(u'apps_ftpaccess')
