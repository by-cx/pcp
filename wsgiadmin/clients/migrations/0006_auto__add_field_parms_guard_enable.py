...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Parms.guard_enable'
        db.add_column('clients_parms', 'guard_enable', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Parms.guard_enable'
        db.delete_column('clients_parms', 'guard_enable')
