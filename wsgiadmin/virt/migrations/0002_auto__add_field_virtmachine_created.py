...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VirtMachine.created'
        db.add_column('virt_virtmachine', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 2, 18, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VirtMachine.created'
        db.delete_column('virt_virtmachine', 'created')
