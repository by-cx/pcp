...
class form_wsgi(forms.Form):
	...
	python_path	= forms.CharField(label=_(u"Python path"), widget=forms.Textarea, help_text=_(u"<br /><strong>~/&lt;zadaná_cesta&gt;</strong> - Jeden řádek, jeden adresář. Formát <strong>/tady/je/moje/aplikace</strong>. Váš domovský adresář bude automaticky doplněn.<br />uWSGI ignoruje nastavení PYTHON_PATH přes sys.path."), required=False)
