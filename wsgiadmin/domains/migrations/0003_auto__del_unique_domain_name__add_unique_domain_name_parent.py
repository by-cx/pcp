...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('domains_domain', ['name'])

        # Adding unique constraint on 'Domain', fields ['name', 'parent']
        db.create_unique('domains_domain', ['name', 'parent_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Domain', fields ['name', 'parent']
        db.delete_unique('domains_domain', ['name', 'parent_id'])

        # Adding unique constraint on 'Domain', fields ['name']
        db.create_unique('domains_domain', ['name'])
