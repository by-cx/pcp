...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Server'
        db.create_table('core_server', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('domain', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('python', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('php', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('mail', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('virt', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal('core', ['Server'])


    def backwards(self, orm):
        # Deleting model 'Server'
        db.delete_table('core_server')
