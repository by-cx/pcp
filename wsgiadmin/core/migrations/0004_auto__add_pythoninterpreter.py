...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PythonInterpreter'
        db.create_table(u'core_pythoninterpreter', (
            ...
            ('virtualenv', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal(u'core', ['PythonInterpreter'])


    def backwards(self, orm):
        # Deleting model 'PythonInterpreter'
        db.delete_table(u'core_pythoninterpreter')
