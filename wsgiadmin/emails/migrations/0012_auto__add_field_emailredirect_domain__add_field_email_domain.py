...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailRedirect.domain'
        db.add_column('emails_redirect', 'domain',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emails.Domain'], null=True),
                      keep_default=False)

        # Adding field 'Email.domain'
        db.add_column('emails_email', 'domain',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emails.Domain'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'emails.email': {
            ...
            'new_domain': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'newdomain_tmp_emails'", 'null': 'True', 'to': "orm['emails.Domain']"}),
        ...
        'emails.emailredirect': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'new_domain': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'newdomain_tmp_redirect'", 'null': 'True', 'to': "orm['emails.Domain']"})
        },
        'emails.message': {
