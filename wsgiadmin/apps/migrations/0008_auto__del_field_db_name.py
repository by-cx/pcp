...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Db.name'
        db.delete_column('apps_db', 'name')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Db.name'
        raise RuntimeError("Cannot reverse this migration. 'Db.name' and its values cannot be restored.")
    ...
    models = {
        'apps.app': {
            ...
            'server': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['apps.Server']"}),
        ...
        'apps.server': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'})
        },
        'auth.group': {
