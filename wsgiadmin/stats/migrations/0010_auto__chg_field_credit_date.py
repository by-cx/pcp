...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Credit.date'
        db.alter_column('stats_credit', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Credit.date'
        db.alter_column('stats_credit', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
