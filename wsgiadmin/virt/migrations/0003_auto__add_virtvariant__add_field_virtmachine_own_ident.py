...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('virt_virtvariant', (
        ...
        db.send_create_signal('virt', ['VirtVariant'])

        # Adding field 'VirtMachine.own_ident'
        db.add_column('virt_virtmachine', 'own_ident',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('virt_virtvariant')

        # Deleting field 'VirtMachine.own_ident'
        db.delete_column('virt_virtmachine', 'own_ident')
