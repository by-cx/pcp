...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('apacheconf_site', (
            ...
            ('domains', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('documentRoot', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ...
            ('script', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('processes', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('threads', self.gf('django.db.models.fields.IntegerField')(default=5)),
            ('virtualenv', self.gf('django.db.models.fields.CharField')(default='default', max_length=100)),
        ...
        db.send_create_signal('apacheconf', ['UserSite'])
    ...
    models = {
        'apacheconf.usersite': {
            ...
            'documentRoot': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
