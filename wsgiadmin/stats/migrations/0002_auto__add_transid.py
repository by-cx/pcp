...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TransId'
        db.create_table(u'stats_transid', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trans_id', self.gf('django.db.models.fields.IntegerField')()),
            ('credit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stats.Credit'])),
        ))
        db.send_create_signal(u'stats', ['TransId'])


    def backwards(self, orm):
        # Deleting model 'TransId'
        db.delete_table(u'stats_transid')
    ...
    models = {
        ...
        u'stats.transid': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'trans_id': ('django.db.models.fields.IntegerField', [], {})
        }
    }
