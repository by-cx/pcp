...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.order_num'
        db.add_column('dns_record', 'order_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Record.prio'
        db.alter_column('dns_record', 'prio', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Record.order_num'
        db.delete_column('dns_record', 'order_num')


        # User chose to not deal with backwards NULL issues for 'Record.prio'
        raise RuntimeError("Cannot reverse this migration. 'Record.prio' and its values cannot be restored.")
