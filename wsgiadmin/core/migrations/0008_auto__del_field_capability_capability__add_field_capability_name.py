...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Capability.capability'
        db.delete_column('core_capability', 'capability')

        # Adding field 'Capability.name'
        db.add_column('core_capability', 'name',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Capability.capability'
        raise RuntimeError("Cannot reverse this migration. 'Capability.capability' and its values cannot be restored.")
        # Deleting field 'Capability.name'
        db.delete_column('core_capability', 'name')
