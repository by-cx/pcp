...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'stats_discountcode', (
        ...
        db.send_create_signal(u'stats', ['DiscountCode'])

        # Adding field 'AssignedDiscountCode.counter'
        db.add_column(u'stats_assigneddiscountcode', 'counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'AssignedDiscountCode.discount_code'
        db.alter_column(u'stats_assigneddiscountcode', 'discount_code_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stats.DiscountCode']))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'stats_discountcode')

        # Deleting field 'AssignedDiscountCode.counter'
        db.delete_column(u'stats_assigneddiscountcode', 'counter')


        # Changing field 'AssignedDiscountCode.discount_code'
        db.alter_column(u'stats_assigneddiscountcode', 'discount_code_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stats.DiscountCodes']))
    ...
    models = {
        ...
        u'stats.assigneddiscountcode': {
            ...
            'counter': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'discount_code': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['stats.DiscountCode']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
