...
urlpatterns = patterns('',
       ...
       url(r'^add_uwsgi/$', AppCreateView.as_view(app_type="uwsgi"), name="app_add_uwsgi"),
       ...
       url(r'^set_uwsgi/(?P<app_id>\d+)/$', AppParametersView.as_view(app_type="uwsgi"), name="app_params_uwsgi"),
