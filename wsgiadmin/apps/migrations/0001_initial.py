...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'apps_app', (
            ...
            ('app_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('domains', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('parameters_data', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('addons_data', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('ssl_cert', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('ssl_key', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('core_server', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Server'], null=True)),
            ('db_server', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='app_db_set', null=True, to=orm['core.Server'])),
        ))
        db.send_create_signal(u'apps', ['App'])

        # Adding model 'Db'
        db.create_table(u'apps_db', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal(u'apps', ['Db'])
