...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('apps_server', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Server.comment'
        db.add_column('apps_server', 'comment',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('apps_server', 'ip')

        # Deleting field 'Server.comment'
        db.delete_column('apps_server', 'comment')
