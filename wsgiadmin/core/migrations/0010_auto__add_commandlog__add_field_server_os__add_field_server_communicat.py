...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Server.os'
        db.add_column(u'core_server', 'os',
                      self.gf('django.db.models.fields.CharField')(default='debian6', max_length=64),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Server.os'
        db.delete_column(u'core_server', 'os')
    ...
    models = {
        ...
        u'core.server': {
            ...
            'communication_key': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
