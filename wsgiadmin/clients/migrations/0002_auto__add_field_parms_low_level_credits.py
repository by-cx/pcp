...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Parms.low_level_credits'
        db.add_column('clients_parms', 'low_level_credits', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Parms.low_level_credits'
        db.delete_column('clients_parms', 'low_level_credits')
    ...
    models = {
        ...
        'clients.parms': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'low_level_credits': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'}),
